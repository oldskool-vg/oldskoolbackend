...
//   //we need cardService.addCard(id) to be called for each card in the list of card names we have. We can do this by autowiring the cardService into our migration script.
//   @Autowired
...
//     System.out.println("Hello from the execution method!");
